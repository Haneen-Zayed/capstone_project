        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <?php if (Helper::check_permission(['Admin','Accountant', 'Seller','Procurement'])) : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="/user?id=<?= $_SESSION['user']['user_id']?>">My Profile</a>
                        </li>
                        <?php endif; ?>
                        <li class="nav-item">
        ...
        <div class="col-2 admin-links">
            <ul class="list-group list-group-flush mt-3">
                ...
                if (Helper::check_permission(['Admin','Accountant'])) : ?>
                    <li class="list-group-item">
                        <a href="/transactions">Transactions management</a>
                    </li>
                <?php endif;
                if (Helper::check_permission(['Admin','Seller'])) :
                ?>
                    <li class="list-group-item">
                        <a href="/transactions/create">Create Transactions</a>
                    </li>
                <?php endif;
                if (Helper::check_permission(['Admin'])) :
                ?>
                    <li class="list-group-item">
                        <a href="/users">User's management</a>
                    </li>
                <?php endif;
                if (Helper::check_permission(['Admin'])) :
                ?>
